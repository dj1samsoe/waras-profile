  ...
  return (
    ...
    >
      ...
      >
        ...
        <Breakline className="w-24 border-2 border-tertiary-red" />
        <p className="text-md">
        ...
        {FACILITIES?.map((item, index) => (
          ...
          >
            ...
            >
              ...
              />
              <div className="absolute top-0 left-0 z-[50] bottom-0 right-0 w-full h-full bg-gradient-to-t from-tertiary-red/90 via-tertiary-red/60 to-tertiary-red/20 rounded-2xl">
