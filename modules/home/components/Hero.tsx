        ...
        <div className="lg:col-span-3 space-y-5 h-screen flex flex-col justify-center">
          ...
          >
            ...
            <Link
              ...
              target="_blank"
              className="px-5 py-3 uppercase tracking-wide font-semibold font-openSans rounded-full bg-neutral-800 md:text-lg text-md text-primary-white flex items-center gap-3 hover:bg-neutral-950 transition-all duration-300 max-w-[16rem]"
            >
